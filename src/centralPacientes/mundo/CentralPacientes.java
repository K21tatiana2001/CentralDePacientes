...
public class CentralPacientes {
    ...
    public void agregarPacienteAlComienzo(Paciente pac) {
        ...
        if (!existePaciente(pac.darCodigo())) {
            ...
            // Lanzar una excepción o mostrar un mensaje de error, ya que no se pueden tener pacientes con el mismo código
            throw new IllegalArgumentException("Ya existe un paciente con el mismo código.");
        }
    }
    ...
    public void agregarPacienteAntesDe(int cod, Paciente pac) throws NoExisteException {
        ...
        if (indice == -1) {
            throw new NoExisteException("No existe un paciente con código " + cod);
        } else {
 ...
 */
    ...
    public String metodo4() {
        // TODO: Completar
        // Inicializar variables para llevar el seguimiento de la clínica más ocupada
        String clinicaMasOcupada = "";
        int maxPacientes = 0;

        // Iterar a través de las clínicas
        for (String clinica : listaClinicas) {
            ...
            if (pacientesEnClinica > maxPacientes) {
                // Si encontramos una clínica con más pacientes, actualizamos los valores máximos
